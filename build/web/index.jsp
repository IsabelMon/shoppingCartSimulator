...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
            ...
            <a class="navbar-brand" href="#"><i>Qatar 2022</i></a>
        ...
        <div class="container mt-4">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <img src="https://img2.rtve.es/i/?w=1600&i=1668713076321.jpg" alt="Carousel
                   Image">
                    ...
                    <div class="item">
                    <center><img src="https://www.elheraldo.co/sites/default/files/styles/width_820/public/fhouulfxeae0jg7.jpg?itok=Of0OEDOM" alt="Carousel
                   Image"></center>
                    <div class="carousel-caption">
                    <h3>Estadio Al Khor</h3>
                    </div>
                    </div>
                    <div class="item">
                    <center><img src="https://www.elheraldo.co/sites/default/files/styles/width_820/public/fhoxbh2wiairqee.jpg?itok=nYUUL6AU" alt="Carousel Image"></center>
                    <div class="carousel-caption">
                    <h3>Estadio 974</h3>
                    </div>
                    </div>
                    <div class="item">
                    <center><img src="https://www.elheraldo.co/sites/default/files/styles/width_820/public/fhovjbyxwaalkmf.jpg?itok=AFKvrUYA" alt="Carousel Image"></center>
                    <div class="carousel-caption">
                    <h3>Estadio Al Janoub</h3>
                    </div>
                    </div>
                    </div>
                    <!-- Controls -->
